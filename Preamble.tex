...
\definecolor{themeorange}{RGB}{251,178,10}
...
\setmonofont[Ligatures=TeX]{NimbusMono}
...
\newcommand{\setpagetheme}[3]{
	...
	\cfoot{\normalfont\scshape \textcolor{themegreylight}{#3 -- }\docstatus\\\textcolor{themegreylight}{\tiny No responsibility is taken for the correctness of this information.}}
}
