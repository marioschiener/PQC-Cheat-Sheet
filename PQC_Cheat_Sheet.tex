...
\begin{document}
	...
	to take into account if the algorithm is suitable for general use. Finally, by assigning numeric values of 0 = \tripleicon{\montserratbold L}{\faCode}{themegreen}{0.6}{\bfseries C}\hspace{-2mm}= \tripleicon{\montserratbold L}{\faCode}{themegreen}{0.6}{\bfseries S}\hspace{-2mm}, 1 = \tripleicon{\montserratbold M}{\faCode}{themeyellow}{0.6}{\bfseries C}\hspace{-2mm}= \tripleicon{\montserratbold M}{\faCode}{themeyellow}{0.6}{\bfseries S}\hspace{-2mm} and 2 = \tripleicon{\montserratbold H}{\faCode}{themered}{0.6}{\bfseries C}\hspace{-2mm}= \tripleicon{\montserratbold H}{\faCode}{themered}{0.6}{\bfseries S}\hspace{-2mm}, we define
