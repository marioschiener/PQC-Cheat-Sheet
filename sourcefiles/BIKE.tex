...
\begin{algorithmbox}{BIKE (Bit Flipping Key Encapsulation)}
    \begin{minipage}[t]{0.38\textwidth}
        ...
        \begin{center}
            \adjustbox{valign=t}{%
                \GreenAbsoluteSpeedometer(0,-10)[2.25cm][0.75]{Unusable/1-3,Poor/4-5,Good/6-8,Perfect/9-10}{Algorithm Overall Usability Score}{7.45}{10}{\tiny}{\tiny \montserratsemibold}\hspace{1.5cm}}
        \end{center}
        \begin{tabbing}
